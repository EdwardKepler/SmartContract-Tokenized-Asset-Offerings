...
import "./Listing.sol";
    ...
    FunderStruct[] funderStructs;
      ...
      _;
          ...
          function setBuildingLocation(string _buildingLocation) public {
          buildingLocation = _buildingLocation;
          }
          function getBuildingLocation() public constant returns (string) {
          return (buildingLocation);
          }
          function setBuildingAppraisal(string _buildingAppraisal public {
          buildingAppraisal = _buildingAppraisal;
          }
          function getBuildingAppraisal() public constant returns (string) {
