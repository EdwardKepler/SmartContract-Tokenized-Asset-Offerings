...
import "./Listing.sol";
    ...
    // Smart Contract For Collectible Offering [TBO]
    ...
    string  public buildingLocation;
    string  public buildingAppraisal;
    ...
    FunderStruct[] funderStructs;
      ...
      _;
           ...
           // [TCO] Tokenized Collectible Offering
           // Tokenized - [ITO,TDO,TNO,TTO,TRO,TLO,TPO,TMO,TGO,TPO,TEO,TCO]
          ...
          function setCollectibleLocation(string _buildingLocation) public {
          buildingLocation = _buildingLocation;
          }
          function getCollectibleLocation() public constant returns (string) {
          return (buildingLocation);
          }
          function setCollectibleAppraisal(string _collectibleAppraisal public {
          collectibleAppraisal = _collectibleAppraisal;
          }
          function getCollectibleAppraisal() public constant returns (string) {
          return (collectibleAppraisal);
          }
