...
import "./Listing.sol";
    ...
    // Smart Contract For Patent Offering [TPO]
    ...
    string  public patentApproval;
    string  public patentAppraisal;
    ...
    FunderStruct[] funderStructs;
      ...
      _;
          ...
          function setPatentApproval(string _patentApproval) public {
          patentApproval = _patentApproval;
          }
          function getPatentApproval() public constant returns (string) {
          return (patentApproval);
          }
          function setPatentAppraisal(string _patentAppraisal public {
          patentAppraisal = _patentAppraisal;
          }
          function getPatentAppraisal() public constant returns (string) {
          return (patentAppraisal);
          }
