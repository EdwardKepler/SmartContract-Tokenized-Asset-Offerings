...
import "./Listing.sol";
    ...
    // Smart Contract For Property[Building] Offering [TBO]
    ...
    FunderStruct[] funderStructs;
      ...
      _;
           ...
           // [TBO] Tokenized Equipment Offering
           // Tokenized - [ITO,TDO,TNO,TTO,TRO,TLO,TPO,TMO,TGO,TPO,TCO,TEO]
          ...
          function setEquipmentLocation(string _buildingLocation) public {
          buildingLocation = _buildingLocation;
          }
          function getEquipmentLocation() public constant returns (string) {
          return (buildingLocation);
          }
          function setEquipmentAppraisal(string _buildingAppraisal public {
          buildingAppraisal = _buildingAppraisal;
          }
          function getEquipmentAppraisal() public constant returns (string) {
